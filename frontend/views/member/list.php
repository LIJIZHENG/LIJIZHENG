    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            ...
            <ul>
                ...
                <li>
                    <dl>
                        <dt><a href="<?=\yii\helpers\Url::to(['/order/details','id'=>$value->id])?>"><img src="<?=$value->logo?>" alt=""/></a></dt>
                        <dt><a href="<?=\yii\helpers\Url::to(['/order/details','id'=>$value->id])?>">"><?=$value->name?></a></dt>
                        <dt><a href="<?=\yii\helpers\Url::to(['/order/details','id'=>$value->id])?>">"><em>已有10人评价</em></a></dt>
                    </dl>
                <?php endforeach;?>
                </li>
            </ul>
